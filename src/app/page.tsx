    ...
    return (
        <div className={`${geistSans.variable} ${geistMono.variable} antialiased h-550`}>
            ...
            <div className="absolute top-0 overflow-y-hidden z-[-1] h-full w-full">
                ...
                <div className="flex-col p-60 pt-40 font-sans items-center text-center justify-center h-full mt-22 w-full bg-transparent">
                    <p className="text-7xl text-white">
                        Interested in Rocket Engines, Satellites, or Space Exploration?
                    </p> 
                    <br />
                    <p className="text-2xl mt-10 text-white">Show up to one of our committee meetings or
            ...
            <div className="relative p-2 pb-0 bg-amber-50 w-full h-216.5 mt-169">
                <Gallery>
            ...
            <div className="flex-col justify-center pt-20 align-middle text-center h-90 w-full">
            ...
            <div className="h-60 bg-amber-50 w-full text-black"> {/* TODO: add google calendar  PLACEHOLDER HERE*/}CALENDAR HERE </div>
